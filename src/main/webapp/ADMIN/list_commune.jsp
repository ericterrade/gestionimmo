...
<head>
  <meta charset="utf-8">
  <title>Gestion Immo | Liste des Communes et des Quartiers</title>
          ...
          <section class="panel">
            ...
            <div class="pull-out">
              <table class="table table-striped m-b-none" data-ride="datatables">
                <thead>
                  <tr>
                    <th width="30%">Nom Commune</th>
                    <th width="30%">Nombre d'Habitant</th>
                ...
                <tr>
                    <td width="10%">${c.nom }</td>
                   	<td width="10%">${c.nbHabitants }</td>
                    <td width="10%">${c.distance}</td>
                    <td><a href="update_commune.do?id=${c.id }"><i class="icon-pencil"></i></a></td>
                  </tr>
                </c:forEach>
                </tbody>
              </table>
