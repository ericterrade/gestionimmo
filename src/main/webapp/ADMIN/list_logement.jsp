...
<head>
  <meta charset="utf-8">
  <title>Gestion Immo | Liste des Logements</title>
  ...
  <section id="content">
    <section class="main">
      <div class="padder clearfix">
        <h4><i class="icon-table"></i>Logements</h4>
      </div>
      <div class="row">
        <div class="col col-lg-12">
          <section class="panel">
            <header class="panel-heading">Liste des Logements <i class="icon-info-sign text-muted" data-toggle="popover" data-html="true" data-placement="top" data-content="The datatables use ajax to load the data. please put this file on a server to preview." title="" data-trigger="hover" data-original-title="Help"></i> </header>
            <div class="pull-out">
              <table class="table table-striped m-b-none" data-ride="datatables">
                <thead>
                  <tr>
                    <th width="10%">Propriétaire</th>
                    <th width="8%">Montant du Loyer</th>
                    <th width="8%">Superficie</th>
                ...
                <tbody>
                <c:forEach items="${logementDTO}" var="l">
                <tr>
                    <td width="10%">${l.prenom } ${l.nom }</td>
                    <td class="text-success" 	width="8%">${l.montantLoyer } €</td>
                    <td width="8%">${l.superficie}</td>
                    <td width="10%">${l.numRue }&nbsp;${l.nomRue }</td>
                    <td width="10%">${l.libelle }</td>
                    <td width="15%">${l.nomCommune}</td>
                    <td width="8%">${l.codeTypeLogement}</td>
                    <td class="text-success" width="8%">${l.chargesForfaitaires} €</td>
                    <td><a href="update_logement.do?id=${l.id }"><i class="icon-pencil"></i></a></td>
                  </tr>
                </c:forEach>
                </tbody>
              </table>
